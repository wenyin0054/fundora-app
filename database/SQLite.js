...
export const createUser = async (userId, username = null, email = null) => {
  try {
    ...
    console.log(`✅ User ${userId} created/verified`);
  } catch (error) {
...
export const getTotalExpensesLocal = async (userId) => {
  try {
    ...
    console.error("❌ getTotalExpensesLocal error:", error);
    return 0;
  }
};
...
export const updateExpenseLocal = async (
  ...
  try {
    ...
    console.log(`✅ Expense record updated successfully (ID: ${id}) for user ${userId}`);
  } catch (error) {
...
export const getLastMonthTotalExpense = async (userId) => {
  try {
    ...
    console.log("✅ Last month expenses for user", userId, ":", { total, essentialTotal });
...
export const updateGoalLocal = async (userId, id, goalName, description, targetAmount, currentAmount, deadline) => {
  try {
    ...
    console.log(`✅ Goal ID ${id} updated for user ${userId}`);
  } catch (error) {
...
export const updateGoalAmount = async (userId, goalId, amount) => {
  try {
    ...
    console.log(`✅ Goal ${goalId} updated by ${amount} for user ${userId}`);
  } catch (error) {
...
export const getEventTagsLocal = async (userId) => {
  try {
    ...
    console.log(`✅ Retrieved ${results.length} event tags for user ${userId}`);
    return results;
  } catch (error) {
...
export const updateEventTagLocal = async (userId, id, newName, newDescription) => {
  try {
    ...
    console.log(`✅ Event tag ID ${id} updated for user ${userId}`);
    DeviceEventEmitter.emit("eventTagsUpdated");
  } catch (error) {
...
export const addActiveEventTagLocal = async (userId, eventTagId, startDate, endDate) => {
  try {
    ...
    console.log(`✅ Active event tag added for user ${userId}`);
  } catch (error) {
...
export const addBillLocal = async ({
  ...
  try {
    ...
    console.error("❌ addBillLocal error:", err);
    throw err;
  }
};
...
export const getBillsLocal = async (userId) => {
  try {
    ...
    console.error("❌ getBillsLocal error:", err);
    return [];
  }
};
...
export const getPeriodicBillsLocal = async (userId) => {
  try {
    ...
    console.error("❌ getPeriodicBillsLocal error:", err);
    return [];
  }
};
...
export const getAutoGeneratedBillsLocal = async (userId) => {
  try {
    ...
    console.error("❌ getAutoGeneratedBillsLocal error:", err);
    return [];
  }
};
...
export const getRemindersLocal = async (userId, limit = 5) => {
  try {
    ...
    console.error("❌ getRemindersLocal error:", err);
    return [];
  }
};
...
export const deleteReminderLocal = async (userId, id) => {
  try {
    ...
    console.log(`🗑️ Reminder ID ${id} deleted for user ${userId}`);
  } catch (err) {
    console.error("❌ deleteReminderLocal error:", err);
  }
};
...
export const checkDueBillsAndGenerateReminders = async (userId) => {
  try {
      ...
      try {
        ...
        if ((newStatus === "Overdue" || newStatus === "DueSoon") && reminderDate) {
          ...
          if (!existing) {
            const message =
              newStatus === "Overdue"
                ? `❗ ${b.billName} is overdue.`
                : `⏳ ${b.billName} is due in ${Math.max(0, daysDiff)} day(s).`;
    ...
    console.error("❌ checkDueBillsAndGenerateReminders error:", err);
  }
};
...
export const getMonthlyDebtSum = async (userId) => {
  try {
    ...
    console.error("❌ getMonthlyDebtSum error:", err);
    return 0;
  }
};
...
export async function getUserTag(userId, payee) {
  ...
  try {
    ...
    console.log("🔍 getUserTag RESULT:", row);
    return row ?? null;
  } catch (err) {
    console.error("❌ getUserTag error:", err);
    return null;
  }
}
...
export async function saveUserTag(userId, payee, tag, is_custom = 0) {
  ...
  try {
    ...
    if (existing) {
      ...
      console.log(`✅ Saved new tag for "${payee}" -> "${tag}"`);
    }
...
export async function clearUserPredictions(userId) {
  try {
    ...
    console.log(`✅ Cleared predictions for user ${userId}`);
    return true;
  } catch (err) {
...
export const addSavingMethod = async (userId, methodData) => {
  try {
    ...
    console.log(`✅ Saving method '${methodData.method_name}' added`);
    return true;
  } catch (error) {
    console.error("❌ addSavingMethod error:", error);
    return false;
  }
};
...
export const updateSavingMethod = async (userId, methodId, methodData) => {
  try {
    ...
    console.log(`✅ Saving method ${methodId} updated`);
    return true;
  } catch (error) {
...
export const deleteSavingMethod = async (userId, methodId) => {
  try {
    ...
    console.log(`✅ Saving method ${methodId} deleted`);
    return true;
  } catch (error) {
    console.error("❌ deleteSavingMethod error:", error);
    throw error;
  }
};
...
export const hasPendingWithdrawal = async (userId, allocationId) => {
  try {
    ...
    console.error("❌ hasPendingWithdrawal error:", error);
    return false;
  }
};
